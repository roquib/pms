        ...
        <div class="topmenu-outer">
            <div class="top-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic"
                            data-toggle="dropdown"><i class="fa fa-bell fa-spin"></i><span
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic"
                            ...
                            <img class="img-circle avatar" src="{{asset('admin/assets/images/default.png')}}"
                                height="40" width="40" alt="">
                            @endif
                        </a>
                        <ul class="dropdown-menu dropdown-list" role="menu">
                            <li role="presentation"><a href="{{route('profile')}}"><i
                                        class="fa fa-user fa-spin"></i>Profile</a>
                            </li>
                            <li role="presentation"><a href="{{route('setting')}}"><i
                                        class="fa fa-gear fa-spin"></i>Setting</a>
                            </li>
                            ...
                            <li role="presentation"><a href="{{ route('logout') }}"><i
