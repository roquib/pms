<div class="navbar">
    <div class="navbar-inner">
        ...
        <div class="logo-box">
            <a href="index.html" class="logo-text"><span class="logo-style">{{Auth::user()->username}}</span></a>
        </div><!-- Logo Box -->
        ...
        <div class="topmenu-outer">
                                        ...
                                        <a href="#">
                                            <div class="msg-img">
                                                <div class="online on"></div><img class="img-circle"
                                                    src="{{asset('admin/assets/images/avatar2.png')}}" alt="">
            </div>
                ...
                <a href="#">
                    <div class="msg-img">
                        <div class="online off"></div><img class="img-circle"
                            src="{{asset('admin/assets/images/avatar4.png')}}" alt="">
                    </div>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown"><i
                        class="fa fa-bell fa-spin"></i><span class="badge badge-success pull-right">3</span></a>
                <ul class="dropdown-menu title-caret dropdown-lg" role="menu">
                    <li>
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                    ...
                    <img class="img-circle avatar" src="{{asset('admin/assets/images/default.png')}}" height="40"
                        width="40" alt="">
                    @endif
                </a>
                <ul class="dropdown-menu dropdown-list" role="menu">
                    <li role="presentation"><a href="{{route('profile')}}"><i class="fa fa-user fa-spin"></i>Profile</a>
                    </li>
                    <li role="presentation"><a href="{{route('setting')}}"><i class="fa fa-gear fa-spin"></i>Setting</a>
                    </li>
                    <li role="presentation"><a href="calendar.html"><i class="fa fa-calendar fa-spin"></i>Calendar</a>
                    </li>
