	...
	<div class="container">
        ...
        <form class="appointment-form" id="frm-create-appointment" method="POST" action="{{route('appointmentConfirm')}}">
			...
			<div class="form-row appointment-form-row ">
				...
				<div class="col-sm-12">
					...
					<h3 class="appointment-heading-3"><p class="appointment-title"> Appointment</p></h3>
			...
			<div class="form-row appointment-form-row ">
				...
				<div class="col-sm-3 text-left">
					...
					<label class="appointment-form-label" 
					for="name "> Name <span class="req_color">*</span> </label>
					
				</div>
				  
				<div class="form-group col-sm-5 appointment-form-group ">
					  
					<input type="text" class="form-control appointment-form-control"
					id="name" name="name" placeholder=" Type Your Name"  value="{{Auth::user()->name}}"
					required />
			...
			<div class="form-row appointment-form-row ">
				...
				<div class="col-sm-3 text-left">
					...
					<label class="appointment-form-label"  for="input-Email">Phone/Email <span class="req_color">*</span> </label>
					
				</div>
				  
				<div class="form-group col-sm-5 appointment-form-group">
					  
					<input type="text" class="form-control appointment-form-control" id="input-Email" name="phone_number" placeholder="Type Your Phone or Email" value="{{Auth::user()->phone}}" required />
		...
		<div class="form-row appointment-form-row">
            ...
            <div class="col-sm-3 text-left">
                ...
                <label for="input-Gender"  class="appointment-form-label"  >Gender <span class="req_color">*</span> </label>
			...
			<div class="form-row appointment-form-row">
				...
				<div class="col-sm-3 text-left">
					...
					<label  class="appointment-form-label"  for="department">Department<span class="req_color">*</span>  </label>
            ...
            <div class="form-group col-sm-5 appointment-form-group">
                ...
                <select class="form-control appointment-form-control"    
                    onclick="chooseDoctor(this)" id="doctor" name="doctor">
                </select>
			...
			<div class="form-row appointment-form-row">
				...
				<div class=" form-group col-sm-5 appointment-form-group">
					...
					<input type="date" class="form-control appointment-form-control   date_padd_top" name="date" id="input-Zip" required />
			...
			<div class="form-row appointment-form-row">
				...
				<div class="col-sm-3 text-left">
					...
					<label class="appointment-form-label"  for="input-Address">Address <span class="req_color">*</span> </label>
						
				</div>
					
				<div class=" form-group col-sm-5 appointment-form-group">
					
					<input type="text" class="form-control appointment-form-control" id="input-Address" name="address" placeholder=" Type Your Full Address" required />
