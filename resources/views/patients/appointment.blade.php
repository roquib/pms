...
<div class="main-content">
    ...
    <div class="container">
        ...
        <form class="appointment-form" id="frm-create-appointment" method="POST"
            action="{{route('appointmentConfirm')}}">
            @csrf
            ...
            <div class="form-row appointment-form-row ">
                ...
                <div class="form-group col-sm-5 appointment-form-group">
                    ...
                    <input type="text" class="form-control appointment-form-control" id="input-Email"
                        name="phone_number" placeholder="Type Your Phone or Email" value="{{Auth::user()->phone}}"
                        required />
